...
public class BMIRasterModelInstance extends Instance implements IModelInstance, IModelExtensions {
     ...
     * The interpolation has to be done for each observation separately, since for each observation
    ...
    public IVector getObservedValues(IObservationDescriptions observationDescriptions) {
            ...
            return GeometryUtils.getObservedValuesBilinearInterpolation(modelGeometryInfo, observationsGeometryInfo, modelValues);
    }
    ...
    private static IExchangeItem getSingleObservationsExchangeItem(IObservationDescriptions observationDescriptions) {
            ...
            if (!(previousExchangeItem instanceof IExchangeItem)) {
                    throw new IllegalArgumentException("Given observationDescriptions should contain an exchange item that is a subclass of " + IExchangeItem.class.getName());
            }
